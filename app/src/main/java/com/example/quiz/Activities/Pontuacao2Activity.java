...
import com.example.quiz.databinding.ActivityPontuacao2Binding;
...
public class Pontuacao2Activity extends AppCompatActivity {

    ActivityPontuacao2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPontuacao2Binding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        fase2 = getIntent().getStringExtra("fase2");
        ...
        binding.buttonSair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Pontuacao2Activity.this, Fases2Activity.class);
    ...
    private void salvar() {
        ...
        firebaseFirestore.collection("Mat").document(fase2).set(map)
