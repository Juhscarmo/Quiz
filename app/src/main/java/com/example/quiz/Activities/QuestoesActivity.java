...
import com.example.quiz.databinding.ActivityQuestoesBinding;
...
public class QuestoesActivity extends AppCompatActivity {
    ...
    ActivityQuestoesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuestoesBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        resetarTempo();
        tempo.start();

        String setNome = getIntent().getStringExtra("fase");
        ...
        binding.buttonProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (posicao == list.size()){
                    Intent intent = new Intent(QuestoesActivity.this, PontuacaoActivity.class);
                    intent.putExtra("fase",setNome);
    ...
    private void setFaseUm() {
        ...
        list.add(new QuestoesModel("1. Pergunta aleatória de Java aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 1"));

        list.add(new QuestoesModel("2. Pergunta aleatória de Java aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 2"));

        list.add(new QuestoesModel("3. Pergunta aleatória de Java aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 3"));

        list.add(new QuestoesModel("4. Pergunta aleatória de Java aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));

        list.add(new QuestoesModel("5. Pergunta aleatória de Java aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));
    }
    ...
    private void resetarTempo() {
        ...
        tempo = new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                Dialog dialog = new Dialog(QuestoesActivity.this);
                ...
                dialog.findViewById(R.id.button_tentardnv).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(QuestoesActivity.this, FasesActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
