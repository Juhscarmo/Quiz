...
import com.example.quiz.databinding.ActivityPontuacaoBinding;
...
public class PontuacaoActivity extends AppCompatActivity {
    ...
    ActivityPontuacaoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPontuacaoBinding.inflate(getLayoutInflater());
        ...
        binding.buttonSair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PontuacaoActivity.this, FasesActivity.class);
    ...
    private void salvar() {
        ...
        firebaseFirestore.collection("Java").document(fase).set(map)
