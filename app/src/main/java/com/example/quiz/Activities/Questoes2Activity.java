...
import com.example.quiz.databinding.ActivityQuestoes2Binding;

import java.util.ArrayList;

//Questões Matemática
public class Questoes2Activity extends AppCompatActivity {

    ActivityQuestoes2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuestoes2Binding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        resetarTempo();
        tempo.start();

        String setNome = getIntent().getStringExtra("fase2");
        ...
        binding.buttonProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (posicao == list.size()){
                    Intent intent = new Intent(Questoes2Activity.this, Pontuacao2Activity.class);
                    intent.putExtra("fase2",setNome);
    ...
    private void setFaseUm() {
        ...
        list.add(new QuestoesModel("1. Pergunta aleatória de matemática aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 1"));

        list.add(new QuestoesModel("2. Pergunta aleatória de matemática aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 2"));

        list.add(new QuestoesModel("3. Pergunta aleatória de matemática aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 3"));

        list.add(new QuestoesModel("4. Pergunta aleatória de matemática aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));

        list.add(new QuestoesModel("5. Pergunta aleatória de matemática aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));
    }
    ...
    private void resetarTempo() {
        ...
        tempo = new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                Dialog dialog = new Dialog(Questoes2Activity.this);
                ...
                dialog.findViewById(R.id.button_tentardnv).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(Questoes2Activity.this, Fases2Activity.class);
                        startActivity(intent);
                        finish();
                    }
                });
