...
import com.example.quiz.databinding.ActivityQuestoes3Binding;

import java.util.ArrayList;

//Questões CSS
public class Questoes3Activity extends AppCompatActivity {

    ActivityQuestoes3Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuestoes3Binding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        resetarTempo();
        tempo.start();

        String setNome = getIntent().getStringExtra("fase3");
        ...
        binding.buttonProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (posicao == list.size()){
                    Intent intent = new Intent(Questoes3Activity.this, Pontuacao3Activity.class);
                    intent.putExtra("fase3",setNome);
    ...
    private void setFaseUm() {
        ...
        list.add(new QuestoesModel("1. Pergunta aleatória de CSS aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 1"));

        list.add(new QuestoesModel("2. Pergunta aleatória de CSS aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 2"));

        list.add(new QuestoesModel("3. Pergunta aleatória de CSS aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 3"));

        list.add(new QuestoesModel("4. Pergunta aleatória de CSS aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));

        list.add(new QuestoesModel("5. Pergunta aleatória de CSS aqui.",
                "Resposta 1", "Resposta 2", "Resposta 3", "Resposta 4",
                "Resposta 4"));
    }
    ...
    private void resetarTempo() {
        ...
        tempo = new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                Dialog dialog = new Dialog(Questoes3Activity.this);
                ...
                dialog.findViewById(R.id.button_tentardnv).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(Questoes3Activity.this, Fases3Activity.class);
                        startActivity(intent);
                        finish();
                    }
                });
